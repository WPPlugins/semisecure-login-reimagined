...
Plugin URI: http://moggy.laceous.com/2010/06/03/semisecure-login-reimagined-v3-1/
...
/*
    ...
    This plugin requires at least WP 2.8 and PHP 4.3
...
/**
 * If this is a multisite install, but you want this plugin to behave as though it is a single site install, set this to TRUE
 * Allowed values: TRUE or FALSE (the default is FALSE)
 */
if (!defined('SEMISECURELOGIN_REIMAGINED__OVERRIDE_IS_MULTISITE'))
	define('SEMISECURELOGIN_REIMAGINED__OVERRIDE_IS_MULTISITE', FALSE);
