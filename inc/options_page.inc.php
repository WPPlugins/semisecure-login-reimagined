...
?>
<div class="wrap">
<div class="icon32" id="<?php if ($this->is_multisite()) {echo 'icon-ms-admin';} else {echo 'icon-options-general';} ?>"><br/></div>
	...
	<table class="form-table">
		...
		<tr valign="top">
			...
			<td>
				...
				<br/><?php printf(__('This plugin is tested to work with UTF-8. You can individually edit your <a href="%s">blog settings</a> or, for multisite installs, globally force the option here without having to edit each and every site in your network.<br /><em>Note: This option does not change the blog_charset in the database.</em>', $this->text_domain), 'options-reading.php'); ?>
			</td>
		</tr>
		<tr valign="top">
